<header class="header" id="header">
    <section class="social" id="social">
        <div class="container">
            <ul class="social__nav-list f-elements f-col f-elements--center md:f-row gap-sm">
                ...
                <li class="social__nav-item f-elements f-elements--center gap-sm px-md">
                    <a href="mailto:donacionessancamilo@gmail.com" class="social__nav-link">
                    ...
                    <a href="mailto:donacionessancamilo@gmail.com" class="list__link" id="social-text-2">donacionessancamilo@gmail.com</a>
                </li>
                <li class="social__nav-item f-elements f-elements--center gap-sm px-md">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock social__nav-img" color="#FF3586" viewBox="0 0 16 16">
                        <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z"/>
                        <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z"/>
                    </svg>
                    <p class="list__link" id="social-text-2">Horario de atención:</br>Lunes a Domingo de 8am a 10pm</p>
                </li>
            </ul>
        </div>
    </section>
    <div class="container bg-white">
        <nav class="nav f-elements f-elements--responsive-2 f-col md:f-row" id="header-nav">
            ...
            <div class="f-elements f-elements--between gap-md py-sm">
                ...
                <div class="f-elements f-elements--center">
                    <a target="_blank" class="button button--primary" href="https://wa.me/+51906276863?text=Hola Traperos De Emaús San Camilo, deseo realizar una donación"><i class="bi bi-balloon-heart"></i> Donar</a>
                </div>
                <div class="d-responsive--reverse">
                    <ul class="social__nav-list g-elements g-template-columns-3fr gap-sm">
                        ...
                        <li class="social__nav-item f-elements f-elements--center gap-sm">
                            <a target="_blank" href="https://wa.me/+51906276863?text=Hola Traperos De Emaús San Camilo, deseo realizar una donación" class="social__nav-link my-auto">
