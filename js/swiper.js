...
var slideContainerTerapia = document.querySelector('.mySwiperTerapias');


// Slider per view

var swiperAboutUs = new Swiper(slideContainerNosotros, {
  slidesPerView: 1,
  spaceBetween: 10,
  effect: "fade",
  pagination: {
...
var swiperTerapias = new Swiper(slideContainerTerapia, {
  slidesPerView: 1,
  spaceBetween: 10,
  effect: "fade",
  pagination: {
